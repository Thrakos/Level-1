...
public class Jeopardy implements ActionListener {
	...
	private JButton createButton(String dollarAmount) {
		...
		JButton moneyButton = new JButton(dollarAmount);
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (buttonPressed == firstButton) {
			askQuestion("This spell makes the target object tranfigured into a bird, bat, or many bats.", "Avifors",
					200);
		}
		...
		if(buttonPressed == secondButton){
			askQuestion("This is the counterspell to Levicorpus", "Liberacorpus", 400);
	...
	private void askQuestion(String question, String correctAnswer, int prizeMoney) {
		...
		if (answer.equals(correctAnswer)) {
			...
			JOptionPane.showMessageDialog(null, "The correct answer was Avifors");
			// Call the updateScore() method
			updateScore();
		}
